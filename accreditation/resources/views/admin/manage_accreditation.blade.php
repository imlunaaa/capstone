<x-app-layout>
    <link rel="stylesheet" href="{{ asset('build/assets/css/manage_accreditation.css') }}">
    <x-slot name="header">
...
=======
                @endif
                <a href="/view_areas/{{$accreditation->program_level_id}}">
                    <div class="card text-bg-light mb-3 shadow p-3 bg-body rounded" >
                        <div class="card-header bg-transparent fs-3">{{ $accreditation->accreditation_name}}: Level {{ $accreditation->prog_level}}</div>
                        <div class="card-body">
                            <h5 class="card-title">{{ $accreditation->accreditation_name}}</h5>
                ...
                <form method="POST" action="{{ route('add_accreditation') }}">
                    <div class="modal-body">
                        <div class="row p-2">
                            ...
                            <center>
                                <h4 class="fs-4">Internal Accreditation</h4>
                            </center>
                            ...
                            <center>
                                <h4 class="fs-4">Enternal Accreditation</h4>
                            </center>
